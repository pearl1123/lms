...
<form method="post" action="<?= base_url('manage_courses/edit/'.$course->id) ?>" id="course-edit-form" data-initial-edit-tab="<?= ! empty($focus_modules) ? 'modules' : '' ?>">
  ...
  <?php if ($phase2_ready_ui): ?>
  <?php include APPPATH . 'views/manage_courses/_phase2_init.php'; ?>
  ...
  <div class="crs-edit-tab-panels">
    ...
    <section class="crs-edit-panel" role="tabpanel" id="crs-edit-panel-access" aria-labelledby="crs-edit-tab-access" data-edit-tab="access" hidden>
      ...
      <?php if ($phase2_ready_ui): ?>
      <?php $this->load->view('manage_courses/_phase2_block_visibility', get_defined_vars()); ?>
      <?php $this->load->view('manage_courses/_phase2_block_access', get_defined_vars()); ?>
      <?php else: ?>
    ...
    <section class="crs-edit-panel" role="tabpanel" id="crs-edit-panel-people" aria-labelledby="crs-edit-tab-people" data-edit-tab="people" hidden>
      ...
      <?php if ($phase2_ready_ui): ?>
      <?php $this->load->view('manage_courses/_phase2_block_instructors', get_defined_vars()); ?>
      <?php $this->load->view('manage_courses/_phase2_block_invitations', get_defined_vars()); ?>
      <?php else: ?>
      <div class="edit-crs-panel">
        <div class="edit-crs-body">
    ...
    <section class="crs-edit-panel" role="tabpanel" id="crs-edit-panel-certificates" aria-labelledby="crs-edit-tab-certificates" data-edit-tab="certificates" hidden>
      ...
      <div class="edit-crs-panel">
        ...
        <div class="edit-crs-body">
          ...
          <?php $this->load->view('manage_courses/_phase3_signatories_block', get_defined_vars()); ?>
          <?php endif; ?>
        </div>
      </div>
    </section>
    ...
    <section class="crs-edit-panel" role="tabpanel" id="crs-edit-panel-batches" aria-labelledby="crs-edit-tab-batches" data-edit-tab="batches" hidden>
      ...
      <div class="edit-crs-panel">
        <div class="edit-crs-body">
          <?php $this->load->view('manage_courses/_phase3_batches_block', get_defined_vars()); ?>
        </div>
      </div>
      <?php else: ?>
      <div class="edit-crs-panel">
  ...
  <?php $this->load->view('manage_courses/_phase3_clone_rows_script', get_defined_vars()); ?>
  <?php endif; ?>

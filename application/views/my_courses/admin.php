...
<div id="mcGridView" class="mc-grid animate__animated animate__fadeInUp animate__fast" style="animation-delay:.1s;">
    ...
    <div class="mc-card animate__animated animate__fadeInUp" style="animation-delay:<?= ($i % 8) * 0.04 ?>s;" data-title="<?= htmlspecialchars(strtolower($course->title)) ?>" data-cat="<?= $course->category_id ?? '' ?>" data-archived="<?= (int)$is_archived ?>">
      <div class="mc-card-thumb" style="background:<?= $grad ?>;">
        ...
        <div class="mc-card-thumb-menu dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li><a class="dropdown-item" href="<?= base_url('index.php/manage_courses/view/'.$course->id) ?>">
      ...
      <div class="mc-card-body">
        ...
        <div class="mc-card-footer">
          <a href="<?= base_url('index.php/manage_courses/edit/'.$course->id) ?>" class="mc-card-btn mc-card-btn-primary">Edit</a>
          <a href="<?= base_url('index.php/manage_courses/view/'.$course->id) ?>" class="mc-card-btn mc-card-btn-primary">View</a>
          <a href="<?= base_url('index.php/manage_courses/delete/'.$course->id) ?>" class="mc-card-btn mc-card-btn-danger" onclick="event.preventDefault(); KA.deleteConfirm(this.href, 'Course')">Delete</a>
        </div>
      </div>
    </div>
    <?php endforeach; ?>
  <?php else: ?>
    <div class="mc-empty" style="grid-column:1/-1;">
      ...
      <a href="<?= base_url('index.php/manage_courses/create') ?>" class="mc-btn mc-btn-primary">Create First Course</a>
    </div>
  <?php endif; ?>
</div>
          ...
          <tr data-title="<?= htmlspecialchars(strtolower($course->title)) ?>" data-cat="<?= $course->category_id ?? '' ?>" data-archived="<?= (int)$is_archived ?>">
            ...
            <td>
              <div class="mc-action-row">
                <a href="<?= base_url('index.php/manage_courses/edit/'.$course->id) ?>" class="mc-action-link mc-action-edit">Edit</a>
                <a href="<?= base_url('index.php/manage_courses/delete/'.$course->id) ?>" class="mc-action-link mc-action-delete" onclick="event.preventDefault(); KA.deleteConfirm(this.href, 'Course')">Delete</a>
              </div>
            </td>
          </tr>
          <?php endforeach; ?>
        <?php else: ?>
          <tr><td colspan="8" style="text-align:center;padding:2.5rem;color:var(--ka-text-muted,#64748b);">No courses found. <a href="<?= base_url('index.php/manage_courses/create') ?>">Create one</a>.</td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>

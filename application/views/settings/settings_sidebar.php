...
<nav class="stg-sidebar" role="tablist" aria-label="Settings sections">
  ...
  <button type="button" class="stg-nav-link" role="tab" data-stg-tab="security" id="stg-nav-security">Security</button>

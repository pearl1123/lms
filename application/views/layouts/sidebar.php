...
<style>
  ...
  .ka-sidebar-user-name { font-size: 0.8125rem; font-weight: 600; color: #fff; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; line-height: 1.3; }
  .ka-sidebar-user-role { font-size: 0.6875rem; color: rgba(255,255,255,0.45); text-transform: capitalize; line-height: 1.3; }
  .ka-sidebar-user-dots {
...
<aside class="ka-sidebar" id="kaSidebar">
  ...
  <nav class="ka-sidebar-scroll">
    ...
    <ul class="ka-nav-list">
      <li class="ka-nav-item">
        <a href="<?= base_url('index.php/dashboard'); ?>"
          ...
          <svg class="ka-nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <li class="ka-nav-item">
        <a href="<?= base_url('index.php/my_courses'); ?>"
          ...
          <?php if (!empty($enrolled_count)): ?>
            <span class="ka-nav-badge"><?= $enrolled_count ?></span>
          <?php endif; ?>
        </a>
      </li>
      <li class="ka-nav-item">
    ...
    <ul class="ka-nav-list">
      ...
      <li class="ka-nav-item">
        <a href="<?= base_url('index.php/leaderboard'); ?>"
          ...
          <svg class="ka-nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M8 21h8M12 21v-4M17 8h.01"/><path d="M5 8H3a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h2M19 8h2a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-2M5 8V6a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v8a4 4 0 0 1-4 4H9a4 4 0 0 1-4-4V8z"/>
          </svg>
          Leaderboard
        </a>
      </li>
    ...
    <?php if (in_array($user_role, ['admin', 'super_admin', 'trainer', 'instructor'])): ?>
    <p class="ka-nav-section">Management</p>
    <ul class="ka-nav-list">

      <?php if (in_array($user_role, ['admin', 'super_admin'])): ?>
      <li class="ka-nav-item">
        <a href="#manageCoursesMenu" class="ka-nav-link <?= in_array($segment, ['manage_courses','modules','lessons']) ? 'active' : '' ?>"
           data-bs-toggle="collapse" aria-expanded="<?= in_array($segment, ['manage_courses','modules','lessons']) ? 'true' : 'false' ?>">
          <svg class="ka-nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/>
          </svg>
          Manage Courses
          <svg class="ka-nav-caret" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            <polyline points="9 18 15 12 9 6"/>
          </svg>
        </a>
        <ul class="ka-nav-submenu collapse <?= in_array($segment, ['manage_courses','modules','lessons']) ? 'show' : '' ?>" id="manageCoursesMenu">
          <li><a href="<?= base_url('index.php/manage_courses'); ?>" class="ka-nav-link <?= $segment === 'manage_courses' && $seg2 === '' ? 'active' : '' ?>">All Courses</a></li>
          <li><a href="<?= base_url('index.php/manage_courses/create'); ?>" class="ka-nav-link <?= $seg2 === 'create' ? 'active' : '' ?>">Create Course</a></li>
          <li><a href="<?= base_url('index.php/categories'); ?>" class="ka-nav-link <?= $segment === 'categories' ? 'active' : '' ?>">Categories</a></li>
        </ul>
      </li>
      <li class="ka-nav-item">
      ...
      <?php if (in_array($user_role, ['trainer', 'instructor', 'admin', 'super_admin'])): ?>
      <li class="ka-nav-item">
  ...
  <div class="dropdown" style="flex-shrink:0;">
    <a href="#" class="ka-sidebar-user" data-bs-toggle="dropdown" aria-expanded="false">
      ...
      <div class="ka-sidebar-user-info">
        ...
        <div class="ka-sidebar-user-role"><?= htmlspecialchars($user_role) ?></div>
      </div>
...
<!-- Main wrapper starts here — close in footer.php -->
